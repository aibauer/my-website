      ...
      return (
        <div className ="container-fluid">
            ...
            <div className ="content">  
              <p className="opening">My name is Andrew Bauer, and I am a fourth-year computer science major at Georgia Tech with concentrations in in Intelligence and People. I have academic and career interests in product management, human computer interaction, and data science. This summer, I am working at American Express as an Associate Product Intern, where I assist as a product manager for their Digital Banking Product Portfolio team by creating Tableau dashboards and data visualizations to provide analytical insight on the overall planning and implementation of American Express' digital checking and savings products.</p>         
