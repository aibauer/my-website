      ...
      return (
        <div className ="container-fluid">
            ...
            <div className ="content">  
              ...
              <p>Outside of the office, I am an avid reader, enjoying primarily short stories, memoirs, and contemporary fiction. I have a major appreciation of storytelling, regardless of the genre. This interest has also launched a new hobby of mine since moving to Chicago: long-form improv. I completed the iO Theater training program in October 2024, and am always seeking opportunities to rehearse and perform on stage. In addition to this, I love going to concerts, comedy shows, and sporting events, and am a huge Mets, Knicks, Jets, and Devils fan.</p>
            </div>
        </div>
